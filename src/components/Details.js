            ...
            {interest.map((char, iden) => {
              return (
                <div className="cardBorder" key={`${iden}`}>
                  ...
                  <div className="charDetails" type="button" onClick={() => dispatch(setDetails(char.id))}>
